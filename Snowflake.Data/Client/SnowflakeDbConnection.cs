...
namespace Snowflake.Data.Client
{
    ...
    public class SnowflakeDbConnection : DbConnection
    {
        ...
        {
            using var activity = this.StartActivity(SnowflakeActivitySourceHelper.OperationConnect);
            ...
            try
            {
                ...
                activity?.SetTag(SnowflakeActivitySourceHelper.Tags.DbSystem, "snowflake");
                activity?.SetTag(SnowflakeActivitySourceHelper.Tags.SessionId, SfSession.sessionId);
        ...
        {
            var activity = this.StartActivity(SnowflakeActivitySourceHelper.OperationConnect);
